...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/signup-image.jpg" width="800" height="800" alt="sing up image">
						</figure>
    ...
    {
    swal("Sorry","Please Enter a name","error");
    }
    if(status == "invalidEmail")
    {
    swal("Sorry","Please Enter a email","error");
    }
    if(status == "invalidUpwd")
    {
    swal("Sorry","Please Enter a password","error");
    }
    if(status == "invalidConfrimPassword")
    {
    swal("Sorry","Please Re-Enter a password","error");
    }
    if(status == "invalidMobile")
    {
    swal("Soory","Invalid Mobile","error");
    }
    if(status == "InvalidMobileLength")
    {
    swal("Congrats","Mobile number length exceded","error");
    }
